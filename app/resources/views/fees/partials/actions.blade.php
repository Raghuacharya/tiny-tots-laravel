<a href="{{ route('admin.fees.show', $fee->id) }}" class="actions_link" title="View">
    <i class="fas fa-eye" style="font-size: 11px;"></i> View
</a>
<a href="{{ route('admin.fees.edit', $fee->id) }}" class="actions_link" title="Edit">
...
<a href="javascript:void(0)" class="open-confirm-modal actions_link" title="Delete"
    ...
    data-action="{{ route('admin.fees.destroy', $fee->id) }}" data-method="DELETE" data-toggle="modal"
